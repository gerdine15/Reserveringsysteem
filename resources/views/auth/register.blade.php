            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="clubNumber" class="col-md-4 col-form-label text-md-right">{{ __('Clubnummer') }}</label>

                            <div class="col-md-6">
                                <input id="clubNumber" type="text" class="form-control @error('clubNumber') is-invalid @enderror" name="clubNumber" value="{{ old('clubNumber') }}" required autocomplete="clubNumber" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="member" class="col-md-4 col-form-label text-md-right">{{ __('Lidnummer') }}</label>
